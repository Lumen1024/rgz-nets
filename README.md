...
Экран состоит из двух блоков, расположенных слева направо, каждый с рамкой:

- **Левый блок** — активный чат: сверху список сообщений, снизу поле ввода нового сообщения.
- **Правый блок** — список доступных чатов.

### Навигация

Навигация между блоками и внутри них осуществляется клавишами:

| Ситуация | Действие | Клавиша |
| :--- | :--- | :--- |
| Ни один блок не активен | Переключение между блоками | `←` / `→` |
| Ни один блок не активен | Войти в выбранный блок | `Enter` |
| Блок с чатом активен | Прокрутка истории сообщений | `↑` / `↓` |
| Блок со списком чатов активен | Выбор чата | `↑` / `↓` |
| Блок со списком чатов активен | Открыть выбранный чат | `Enter` |
